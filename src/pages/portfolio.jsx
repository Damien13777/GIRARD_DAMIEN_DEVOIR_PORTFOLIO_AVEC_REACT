...
export default function Portfolio() {
  ...
  useSEO(
    'Portfolio - Mes Réalisations | John Doe',
    'Découvrez mes derniers projets web : Fresh Food, Restaurant Akira, site Clochette-nails et autres réalisations.'
  );
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "Site vitrine pour un salon de manucure avec prise de rendez-vous en ligne",
  ...
  return (
    <>
        ...
        <Container>
          <Row>
            <Col className="text-center">
              <h1 className="portfolio-main-title mb-3">Portfolio</h1>
      ...
      <div className="portfolio-section pb-5 pt-0 bg-white">
        <Container>
          <Row className="g-4">
